    ...
    <section class="">
        ...
        <div class="container ">
            ...
            <div class="d-flex justify-content-end">
                <a class="btn bg_special text-end strong_shadow" href="{{ route('admin.apartments.create') }}"> <span
                        class="icon">
                            ...
                            <div class="index_buttons">
                                <div class="d-flex justify-content-start flex-wrap">
                                    <a class="btn me-2 btn-light strong_shadow"
                                        href="{{ route('admin.apartments.show', $apartment) }}"> <span class="icon">
                                        ...
                                        <span class="text_from_left">Dettagli</span></a>
                                    <a class="btn me-2 btn-light strong_shadow"
                                        href="{{ route('admin.apartments.edit', $apartment) }}"> <span class="icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                    ...
                                    <form class="" action="{{ route('admin.apartments.destroy', $apartment) }}"
                                        method="post">
                                        @csrf
                                        @method('delete')
