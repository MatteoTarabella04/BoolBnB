...
@section('content')
    ...
    <div class="container">
        <div class="d-flex justify-content-end mt-4">
            <a class="btn bg_special text-end strong_shadow" href="{{ route('admin.apartments.show', $apartment) }}">
                <span class="icon">
                ...
                <span class="text_from_left" style="margin: 10px 0 5px 0;">Ritorna all'annuncio</span></a>
        </div>
        <div class="row">
            <div class="col">
                <div class=" p-3 my-5 ">
