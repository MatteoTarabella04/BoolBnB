                            ...
                            <div class="mb-4 row">
                                ...
                                <div class="col-md-6">
                                    <input id="password" type="password"
                                        ...
                                        required autocomplete="new-password" min="8">
                            ...
                            <div class="mb-4 row">
                                ...
                                <div class="col-md-6">
                                    <input id="first_name" type="text"
                                        ...
                                        value="{{ old('first_name') }}" autocomplete="first_name" autofocus max="50">
                            ...
                            <div class="mb-4 row">
                                ...
                                <div class="col-md-6">
                                    <input id="last_name" type="text"
                                        ...
                                        value="{{ old('last_name') }}" autocomplete="last_name" autofocus max="50">
                            ...
                            <div class="mb-4 row">
                                ...
                                <div class="col-md-6">
                                    <input id="date_of_birth" type="date"
                                        ...
                                        autocomplete="date_of_birth" min="1900-01-01" autofocus>
