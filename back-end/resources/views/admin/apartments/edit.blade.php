        ...
        <div>
            ...
            <form action="{{ route('admin.apartments.update', $apartment) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                  ...
                  <input type="text"
                    class="form-control" name="name" id="name" aria-describedby="helpId" placeholder="" value="{{ old('name', $apartment->name) }}" required>
                  @error('name')
                ...
                <div class="mb-3">
                  ...
                  <input type="number"
                    class="form-control" name="price_per_night" id="price_per_night" aria-describedby="helpId" placeholder="" value="{{ old('price_per_night', $apartment->price_per_night) }}" required>
                ...
                <div class="mb-3">
                  ...
                  <input type="number"
                    class="form-control" name="rooms" id="rooms" aria-describedby="helpId" placeholder="" value="{{ old('rooms', $apartment->rooms) }}" required>
                    @error('rooms')
                ...
                <div class="mb-3">
                  ...
                  <input type="number"
                    class="form-control" name="beds" id="beds" aria-describedby="helpId" placeholder="" value="{{ old('beds', $apartment->beds) }}" required>
                    @error('beds')
                ...
                <div class="mb-3">
                  ...
                  <input type="number"
                    class="form-control" name="bathrooms" id="bathrooms" aria-describedby="helpId" placeholder="" value="{{ old('bathrooms', $apartment->bathrooms) }}" required>
                    @error('bathrooms')
                ...
                <div class="mb-3">
                  ...
                  <input type="number"
                    class="form-control" name="square_meters" id="square_meters" aria-describedby="helpId" placeholder="" value="{{ old('square_meters', $apartment->square_meters) }}" required>
                    @error('square_meters')
                ...
                <div class="mb-3">
                  ...
                  <input type="text"
                    class="form-control" name="address" id="address" aria-describedby="helpId" placeholder="" value="{{ old('address', $apartment->address) }}" required>
                  @error('address')
