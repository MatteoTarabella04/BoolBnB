        ...
        <div class="row">
            ...
            <div class="col-12 d-flex align-items-center flex-wrap rounded-1 m-1">
                <div class="col-12 col-sm-6 col-md-4 p-3">
                    <img src="{{ asset('storage/' . $apartment->image) }}" alt="Immagine {{ $apartment->name }}" class="w-100 rounded-3 strong_shadow">
                </div>
                <div class="col-12 col-sm-6 col-md-8 p-3 d-flex flex-column justify-content-center">
                    ...
                    <div class="index_buttons">
                        <div class="d-flex justify-content-start flex-wrap">
                            <a class="btn me-2 btn-light strong_shadow" href="{{ route('admin.apartments.show', $apartment) }}">
                                <span class="icon">
                            ...
                            <a class="btn me-2 btn-light strong_shadow" href="{{ route('admin.apartments.edit', $apartment) }}">
                                <span class="icon">
