...
<template>
    <form @submit.prevent="sendRegistrationRequest()">
        ...
        <input type="password" name="password_confirmation" id="password_confirmation" placeholder="Insert password again for confirmation" required v-model.trim="password_confirmation">
