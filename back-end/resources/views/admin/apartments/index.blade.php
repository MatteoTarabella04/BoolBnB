                            ...
                            <div class="index_buttons">
                                <div class="d-flex justify-content-start justify-content-sm-center justify-content-md-start flex-wrap flex-sm-column flex-md-row gap-2">
                                    <a class="btn my-2 btn-light strong_shadow"
                                        ...
                                        <span class="icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                fill="currentColor" class="bi bi-eye-fill vertical_align_text_top" viewBox="0 0 16 16">
                                    ...
                                    <a class="btn my-2  btn-light strong_shadow"
                                        ...
                                        <span class="icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                fill="currentColor" class="bi bi-pencil-fill vertical_align_text_top" viewBox="0 0 16 16">
                                                <path
