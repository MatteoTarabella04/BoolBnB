...
@section('content')
    <div class="container py-5 px-2">
        <a class="btn btn-dark" href="{{ route('admin.apartments.index') }}">
            <span class="icon">
            ...
            <span class="text_from_left">Elenco appartamenti</span>
        </a>

        <div class="info_container mt-4 d-flex justify-content-center flex-wrap">
            <div class="image col-12 col-md-6 col-lg-4 d-flex justify-content-center flex-column">
                <img src="{{ asset('storage/' . $apartment->image) }}" class="rounded-4 shadow"
                ...
                <input type="text" class="form-control d-none" name="latitude" id="latitude" aria-describedby="helpId"
                    placeholder="" value="{{ old('latitude', $apartment->latitude) }}" required>
                <input type="text" class="form-control d-none" name="longitude" id="longitude" aria-describedby="helpId"
                    placeholder="" value="{{ old('longitude', $apartment->longitude) }}" required>

                <div id="map" style="width: 100%;max-width:500px; aspect-ratio: 12 / 9" class="rounded-4 shadow mt-3">
                </div>
            </div>
            <div
                class="mt-4 mt-md-0 col-12 col-md-6 col-lg-8 ps-md-4 d-flex flex-column align-items-start justify-content-center">
                ...
                <div class="d-flex justify-content-start flex-wrap">
                    <a class="btn me-2 btn-dark" href="{{ route('admin.apartments.edit', $apartment) }}"> <span
                            class="icon">
